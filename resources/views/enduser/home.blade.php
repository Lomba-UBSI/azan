            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-7 offset-lg-1">
                    <div class="heading__layout2 mb-60">
                        ...
                        <h3 class="heading__title">We Are Ready For Solar Energy, All We Need Is To Use It Well!
                        </h3>
                ...
                <div class="col">
                    <div class="about__text">
                        ...
                        <p class="heading__desc font-weight-medium color-secondary mb-30">We drive the transition to
                            more
                            sustainable, reliable, and affordable energy systems. With our innovative technologies,
                            we energize
                            society, that’s our aim!
                        </p>
                        <p class="heading__desc mb-20">The increase in extreme weather events and rising sea levels
                            are
                            unmistakable
        ...
        <div class="container">
            <div class="row mb-70">
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-1">
                    <p class="heading__desc font-weight-bold color-gray mb-30">Our Solar business is focused on
                        creating PV
                        material solutions
                    ...
                    <div class="slick-carousel carousel-arrows-light"
                        ...
                        <div class="service-item">
                            ...
                            <div class="service__body">
                                ...
                                <p class="service__desc">A PV module is an assembly of photo voltaic cells mounted
                                    in a framework for
                        ...
                        <div class="service-item">
                            ...
                            <div class="service__body">
                                ...
                                <p class="service__desc">The smallest turbines used for applications such as
                        ...
                        <div class="service-item">
                            ...
                            <div class="service__body">
                                ...
                                <p class="service__desc">Hydroelectric power plants can include a reservoir to
                                    exploit the energy of
                        ...
                        <div class="service-item">
                            ...
                            <div class="service__body">
                                ...
                                <p class="service__desc">Green chemistry is attracting interest as it provides
                                    clean and green
                        ...
                        <div class="service-item">
                            ...
                            <div class="service__body">
                                ...
                                <p class="service__desc">Lithium batteries have become the battery type of choice
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="feature-item">
                                ...
                                <p class="feature__desc">Save money on utilities or increase the value of your home
                                    by installing
                                    solar
                                </p>
                            </div><!-- /.feature-item -->
                        ...
                        <div class="col-sm-6">
                            <div class="feature-item">
                                ...
                                <p class="feature__desc">Everyday the sun provides us with abundance of free energy
                                    by placing solar
                                </p>
                            </div><!-- /.feature-item -->
                        </div><!-- /.col-sm-6 -->
                        ...
                        <div class="col-sm-6">
                            <div class="feature-item">
                                ...
                                <p class="feature__desc">Our remote industrial solar systems are designed to
                                    reliably power our
                                    clients
                                </p>
                            </div><!-- /.feature-item -->
    ...
    <section class="portfolio-layout3 portfolio-carousel pt-120">
        ...
        <div class="container">
            <div class="row mb-60">
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-1">
                    <p class="heading__desc font-weight-bold color-gray mb-30">With our innovative technologies,
                        clear focus on
                        the needs of our
                        ...
                        <div class="slick-carousel carousel-arrows-light carousel-dots-light"
                            ...
                            <div class="portfolio-item">
                                ...
                                <div class="portfolio__body">
                                    ...
                                    <h4 class="portfolio__title"><a href="#">Expanding The Solar Supply
                                            Chain Finance Program</a></h4>
                                    <p class="portfolio__desc">We has announced the expansion of its solar supply
                                        chain finance (SCF)
                            ...
                            <div class="portfolio-item">
                                ...
                                <div class="portfolio__body">
                                    ...
                                    <h4 class="portfolio__title"><a href="#">Addressing Wind Energy
                            ...
                            <div class="portfolio-item">
                                ...
                                <div class="portfolio__body">
                                    ...
                                    <h4 class="portfolio__title"><a href="#">Smarter Ways to Manage EV
                                            Charging Infrastructures</a></h4>
                                    <p class="portfolio__desc">We has announced the expansion of its solar supply
                                        chain finance (SCF)
                                        program for PV module manufacturers...</p>
                                    <a href="projects-single-project.html" class="btn btn__primary btn__sm">
                            ...
                            <div class="portfolio-item">
                                ...
                                <div class="portfolio__body">
                                    ...
                                    <h4 class="portfolio__title"><a href="#">New Public Attitude Tracker
                                            Towards Renewable Energy</a>
                                    </h4>
                                    <p class="portfolio__desc">We has announced the expansion of its solar supply
                                        chain finance (SCF)
                                        program for PV module manufacturers...</p>
                            ...
                            <div class="portfolio-item">
                                ...
                                <div class="portfolio__body">
                                    ...
                                    <h4 class="portfolio__title"><a href="#">Dangerous Environmental Impacts
                                            of Natural Gas</a></h4>
                                    <p class="portfolio__desc">We has announced the expansion of its solar supply
                                        chain finance (SCF)
                                        program for PV module manufacturers...</p>
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="testimonial__panel">
                            <div class="testimonial__desc">
                                As one of the world's largest ITService Providers with over 120 engineers and IT
                                support staff are
                                ready to help.
                            </div>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="cta__item d-flex">
                        ...
                        <div class="cta__body">
                            ...
                            <p class="cta__desc">We collaborate with you to design and deliver a system that meets
                                your utility
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                    <div class="col-inner">
                        <div class="heading-layout2 heading-light mb-60">
                            ...
                            <p class="heading__desc">Our Solar business now provides the preferred channel to
                                market for some of the
                                world’s leading PV manufacturers and our solar professionals work jointly with
                                partners on enhancing
                    ...
                    <div class="contact-panel">
                        <form class="contact-panel__form" method="post" action="assets/php/contact.php"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <span class="font-weight-bold color-heading d-block mb-15 mt-10">System
                                        Data</span>
                                </div><!-- /.col-12 -->
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <span class="font-weight-bold color-heading d-block mb-15 mt-10">Preferred
                                        Contact Method</span>
                                    <div class="d-flex">
    ...
    <section class="clients clients-layout2 border-bottom py-0">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-sm-12 col-md-12 col-lg-6">
                    <strong class="text-center d-block mt-40">Receive an accurate quote within 3-5 days when you
                        fill out the
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
                    <div class="heading text-center mb-50">
                        ...
                        <h3 class="heading__title">Recent Artikels</h3>
                    </div><!-- /.heading -->
                </div><!-- /.col-lg-6 -->
            </div><!-- /.row -->
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="post-item">
                        ...
                        <div class="post__body">
                            ...
                            <h4 class="post__title"><a href="#">Filing Solar Power Permits in 2020? Consider
                                    the Following Important
                                    Factors
                                </a></h4>
                            <p class="post__desc">All of these factors are important to consider when permitting
                                your solar system,
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="post-item">
                        ...
                        <div class="post__body">
                            ...
                            <p class="post__desc">Batteries are the most expensive part of a solar system. Between
                                an
